...
fn worktree_create(args: &[String]) -> std::io::Result<i32> {
    ...
    if workspace_id.is_some() && cwd.is_some() {
        eprintln!(
            "usage: herdr worktree create [--workspace ID | --cwd PATH] [--branch NAME] [--base REF] [--path PATH] [--label TEXT] [--ticket ID] [--pr URL --role ROLE [--active-owner]] [--focus] [--no-focus] [--trust-repository]"
        );
        return Ok(2);
    }
...
fn worktree_open(args: &[String]) -> std::io::Result<i32> {
    ...
    if workspace_id.is_some() && cwd.is_some() {
        eprintln!(
            "usage: herdr worktree open [--workspace ID | --cwd PATH] (--path PATH | --branch NAME) [--label TEXT] [--ticket ID] [--pr URL --role ROLE [--active-owner]] [--focus] [--no-focus] [--trust-repository]"
        );
        return Ok(2);
    }
...
fn print_worktree_help() {
    ...
    eprintln!(
        "  herdr worktree create [--workspace ID | --cwd PATH] [--branch NAME] [--base REF] [--path PATH] [--label TEXT] [--ticket ID] [--pr URL --role ROLE [--active-owner]] [--focus] [--no-focus] [--trust-repository]"
    );
    eprintln!(
        "  herdr worktree open [--workspace ID | --cwd PATH] (--path PATH | --branch NAME) [--label TEXT] [--ticket ID] [--pr URL --role ROLE [--active-owner]] [--focus] [--no-focus] [--trust-repository]"
    );
