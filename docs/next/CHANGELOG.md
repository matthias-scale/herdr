...
- The sidebar now keeps a stable Spaces → tab → pane hierarchy, including agentless tabs. Priority configuration remains compatible but cannot reorder identity rows; completed panes stay `done` until opened, and each tab title is rendered once.
