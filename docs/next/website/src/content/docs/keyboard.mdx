...
These actions use only the focused pane. A ticket opens its canonical Linear URL; otherwise Herdr uses a validated pull request URL. If the pane has no linked work, Herdr shows a notice and does nothing.
