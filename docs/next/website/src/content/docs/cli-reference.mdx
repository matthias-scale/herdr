...
herdr pane work-context set <pane_id> [--ticket ID]... [--pr URL]... [--branch BRANCH] [--title TITLE] [--clear FIELD]...
...
unchanged. `--clear` accepts `ticket_ids`, `pr_urls`, `branch`, or `work_title`.
